...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        tag(ModTags.KNIFE_ENCHANTABLE)
                .add(ModItems.OILED_KNIFE.get()); // 油浸刀
        ...
        // c:syrups/maple_syrup
        tag(ModItemTags.MAPLE_SYRUP).add(ModItems.MAPLE_SYRUP.get()); // 枫糖浆

        // c:flours
        tag(ModItemTags.FLOURS).add(ModItems.FLOUR.get()); // 面粉
        // c:flour
        tag(ModItemTags.FLOUR_SIMPLE).add(ModItems.FLOUR.get()); // 面粉
        // c:flours/wheat
        tag(ModItemTags.WHEAT_IN_FLOURS).add(ModItems.FLOUR.get()); // 面粉
