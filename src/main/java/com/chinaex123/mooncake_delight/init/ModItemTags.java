...
public interface ModItemTags {
    ...
    // 糖
    TagKey<Item> SUGARS = forgeItemTag("sugars"); // c:sugars
    // 椒盐
    TagKey<Item> PEPPER_SALT = forgeItemTag("pepper_salt"); // c:pepper_salt

    // 糖浆
    TagKey<Item> SYRUPS_MAPLE_SYRUP = forgeItemTag("syrups/maple_syrup"); // c:syrups/maple_syrup
    TagKey<Item> SYRUPS_INVERT_SUGAR_SYRUP = forgeItemTag("syrups/invert_sugar_syrup"); // c:syrups/invert_sugar_syrup

    // 面粉
    TagKey<Item> FLOUR = forgeItemTag("flour"); // c:flour
    TagKey<Item> FLOURS = forgeItemTag("flours"); // c:flours
    TagKey<Item> FLOURS_WHEAT = forgeItemTag("flours/wheat"); // c:flours/wheat

    // 莲子
    TagKey<Item> LOTUS = forgeItemTag("lotus"); // c:lotus
    TagKey<Item> CROPS_LOTUS = forgeItemTag("crops/lotus"); // c:crops/lotus

    // 芝麻
    TagKey<Item> SESAMES = forgeItemTag("sesames"); // c:sesames
    TagKey<Item> CROPS_SESAME = forgeItemTag("crops/sesame"); // c:crops/sesame
