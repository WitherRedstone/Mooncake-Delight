...
public class MDFluids {
    ...
    // -------------------- 流体ID --------------------
    // 转换糖浆
    public static final ResourceLocation INVERT_SUGAR_SYRUP_ID = MDFluids.id("invert_sugar_syrup");
    public static final ResourceLocation FLOWING_INVERT_SUGAR_SYRUP_ID = MDFluids.id("flowing_invert_sugar_syrup");
    // 枫糖浆
    public static final ResourceLocation MAPLE_SYRUP_ID = MDFluids.id("maple_syrup");
    public static final ResourceLocation FLOWING_MAPLE_SYRUP_ID = MDFluids.id("flowing_maple_syrup");

    // -------------------- 流体属性 --------------------
    // 参数：流体 ID，掉落伤害，光亮等级，滋润耕地，无限生成
    // 转换糖浆
    public static final Supplier<FluidType> INVERT_SUGAR_SYRUP_TYPE =
            FLUID_TYPES.register("invert_sugar_syrup", () -> new MDFluidTypes(INVERT_SUGAR_SYRUP_ID, 0.4F, 0, false, false));
    // 枫糖浆
    public static final Supplier<FluidType> MAPLE_SYRUP_TYPE =
            FLUID_TYPES.register("maple_syrup", () -> new MDFluidTypes(MAPLE_SYRUP_ID, 0.2F, 0, false, false));
    ...
    public static final Supplier<BaseFlowingFluid.Source> INVERT_SUGAR_SYRUP =
            FLUIDS.register("invert_sugar_syrup", () -> new BaseFlowingFluid.Source(MDFluids.INVERT_SUGAR_SYRUP_PROPERTIES));
    public static final Supplier<BaseFlowingFluid.Flowing> FLOWING_INVERT_SUGAR_SYRUP =
            FLUIDS.register("flowing_invert_sugar_syrup", () -> new BaseFlowingFluid.Flowing(MDFluids.INVERT_SUGAR_SYRUP_PROPERTIES));
    // 枫糖浆
    public static final Supplier<BaseFlowingFluid.Source> MAPLE_SYRUP =
            FLUIDS.register("maple_syrup", () -> new BaseFlowingFluid.Source(MDFluids.MAPLE_SYRUP_PROPERTIES));
    public static final Supplier<BaseFlowingFluid.Flowing> FLOWING_MAPLE_SYRUP =
            FLUIDS.register("flowing_maple_syrup", () -> new BaseFlowingFluid.Flowing(MDFluids.MAPLE_SYRUP_PROPERTIES));
