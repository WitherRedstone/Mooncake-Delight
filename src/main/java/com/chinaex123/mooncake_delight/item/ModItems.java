...
public class ModItems {
    ...
    public static final DeferredItem<Item> MOONCAKE_CRUST_DOUGH = ITEMS_REGISTER.register("mooncake_crust_dough", () -> new Item(new Item.Properties().food(ModFoods.MOONCAKE_CRUST_DOUGH))); // 月饼面团
    public static final DeferredItem<Item> SNOW_SKIN_MOONCAKE_CRUST_DOUGH = ITEMS_REGISTER.register("snow_skin_mooncake_crust_dough", () -> new Item(new Item.Properties().food(ModFoods.SNOW_SKIN_MOONCAKE_CRUST_DOUGH))); // 冰皮月饼面团
    ...
    public static final DeferredItem<Item> GOLDEN_APPLE_MOONCAKE = ITEMS_REGISTER.register("golden_apple_mooncake", () -> new Item(new Item.Properties().food(ModFoods.GOLDEN_APPLE_MOONCAKE).rarity(Rarity.RARE))); // 金苹果月饼
    public static final DeferredItem<Item> ENCHANTED_GOLDEN_APPLE_MOONCAKE = createEnchantedItem("enchanted_golden_apple_mooncake", ModFoods.ENCHANTED_GOLDEN_APPLE_MOONCAKE, Rarity.EPIC); // 附魔苹果月饼
    ...
    public static final DeferredItem<Item> ROTTEN_FLESH_MOONCAKE = ITEMS_REGISTER.register("rotten_flesh_mooncake", () -> new Item(new Item.Properties().food(ModFoods.ROTTEN_FLESH_MOONCAKE))); // 腐肉月饼
    ...
    public static final DeferredItem<Item> HAM_MOONCAKE = ITEMS_REGISTER.register("ham_mooncake", () -> new Item(new Item.Properties().food(ModFoods.HAM_MOONCAKE))); // 火腿月饼
    public static final DeferredItem<Item> YUNNAN_HAM_MOONCAKE = ITEMS_REGISTER.register("yunnan_ham_mooncake", () -> new Item(new Item.Properties().food(ModFoods.YUNNAN_HAM_MOONCAKE))); // 云腿月饼
    ...
    public static final DeferredItem<Item> PORK_CABBAGE_MOONCAKE = ITEMS_REGISTER.register("pork-cabbage_mooncake", () -> new Item(new Item.Properties().food(ModFoods.PORK_CABBAGE_MOONCAKE))); // 猪肉卷心菜月饼
    public static final DeferredItem<Item> BEEF_TOMATO_MOONCAKE = ITEMS_REGISTER.register("beef-tomato_mooncake", () -> new Item(new Item.Properties().food(ModFoods.BEEF_TOMATO_MOONCAKE))); // 牛肉番茄月饼
    public static final DeferredItem<Item> CHICKEN_PUMPKIN_MOONCAKE = ITEMS_REGISTER.register("chicken-pumpkin_mooncake", () -> new Item(new Item.Properties().food(ModFoods.CHICKEN_PUMPKIN_MOONCAKE))); // 鸡肉南瓜月饼
    public static final DeferredItem<Item> HAM_CABBAGE_MOONCAKE = ITEMS_REGISTER.register("ham-cabbage_mooncake", () -> new Item(new Item.Properties().food(ModFoods.HAM_CABBAGE_MOONCAKE))); // 火腿卷心菜月饼
    public static final DeferredItem<Item> SEAFOOD_MOONCAKE = ITEMS_REGISTER.register("seafood_mooncake", () -> new Item(new Item.Properties().food(ModFoods.SEAFOOD_MOONCAKE))); // 海鲜月饼
    public static final DeferredItem<Item> THREE_DELICACIES_MOONCAKE = ITEMS_REGISTER.register("three_delicacies_mooncake", () -> new Item(new Item.Properties().food(ModFoods.THREE_DELICACIES_MOONCAKE))); // 三鲜月饼
    public static final DeferredItem<Item> FAMILY_FEASTS_MOONCAKE = ITEMS_REGISTER.register("family_feasts_mooncake", () -> new Item(new Item.Properties().food(ModFoods.FAMILY_FEASTS_MOONCAKE))); // 全家福月饼
    public static final DeferredItem<Item> DOUBLE_MEAT_MOONCAKE = ITEMS_REGISTER.register("double_meat_mooncake", () -> new Item(new Item.Properties().food(ModFoods.DOUBLE_MEAT_MOONCAKE))); // 双拼肉月饼
    public static final DeferredItem<Item> TRIPLE_MEAT_MOONCAKE = ITEMS_REGISTER.register("triple_meat_mooncake", () -> new Item(new Item.Properties().food(ModFoods.TRIPLE_MEAT_MOONCAKE))); // 三肉月饼
    ...
    public static final DeferredItem<Item> BEDROCK_MOONCAKE = ITEMS_REGISTER.register("bedrock_mooncake", () -> new Item(new Item.Properties().food(ModFoods.BEDROCK_MOONCAKE).rarity(Rarity.EPIC))); // 基岩月饼
