...
public class ModItems {
    ...
    public static final DeferredItem<Item> TURTLE = ITEMS_REGISTER.register("truffle", () -> new Item(new Item.Properties())); // 松露
    ...
    public static final DeferredItem<Item> GOLDEN_APPLE_MOONCAKE = ITEMS_REGISTER.register("golden_apple_mooncake", () -> new Item(new Item.Properties().food(ModFoods.GOLDEN_APPLE_MOONCAKE))); // 金苹果月饼
    public static final DeferredItem<Item> ENCHANTED_GOLDEN_APPLE_MOONCAKE = createEnchantedItem("enchanted_golden_apple_mooncake", ModFoods.ENCHANTED_GOLDEN_APPLE_MOONCAKE); // 附魔苹果月饼
