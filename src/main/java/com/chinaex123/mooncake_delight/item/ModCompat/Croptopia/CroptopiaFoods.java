...
public class CroptopiaFoods {
    ...
    public static final FoodProperties PINEAPPLE_MOONCAKE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).build(); // 菠萝月饼
    public static final FoodProperties STRAWBERRY_MOONCAKE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).build(); // 草莓月饼
    public static final FoodProperties BLUEBERRY_MOONCAKE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).build(); // 蓝莓月饼
    public static final FoodProperties CRANBERRY_MOONCAKE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).build(); // 蔓越莓月饼
    public static final FoodProperties BLACKBERRY_MOONCAKE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).build(); // 黑莓月饼
    public static final FoodProperties COCONUT_PASTE_MOONCAKE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).build(); // 椰蓉月饼
    public static final FoodProperties JUJUBE_PASTE_MOONCAKE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).build(); // 枣泥月饼
    public static final FoodProperties MUNG_MOONCAKE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).build(); // 绿豆月饼
    ...
    public static final FoodProperties TROPICAL_FRUIT_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
    ...
    public static final FoodProperties BERRY_MEDLEY_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
    ...
    public static final FoodProperties CITRUS_BLAST_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 20 * 60 * 20, 2), 1.0f) // 速度
    ...
    public static final FoodProperties CASHEW_MANGO_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 20 * 60 * 10, 2), 1.0f) // 速度
            .alwaysEdible().build(); // 腰果芒果月饼
    public static final FoodProperties SHRIMP_ASPARAGUS_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 20 * 60 * 10, 2), 1.0f) // 速度
            .alwaysEdible().build();  // 鲜虾芦笋月饼
    public static final FoodProperties CRAB_CORNS_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
    ...
    public static final FoodProperties TUNA_AVOCADO_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
    ...
    public static final FoodProperties PINEAPPLE_HAM_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
    ...
    public static final FoodProperties SEAFOOD_MEDLEY_MOONCAKE = new FoodProperties.Builder().nutrition(16).saturationModifier(0.4f)
    ...
    public static final FoodProperties BBQ_PORK_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 20 * 10, 2), 1.0f) // 速度
            .alwaysEdible().build(); // 叉烧月饼
    public static final FoodProperties BBQ_PORK_FIVE_KERNELS_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.LUCK, 20 * 60, 1), 1.0f) // 幸运
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 20 * 10, 2), 1.0f) // 速度
            .alwaysEdible().build(); // 叉烧五仁月饼
    public static final FoodProperties JINHUA_HAM_FIVE_KERNELS_MOONCAKE = new FoodProperties.Builder().nutrition(12).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.LUCK, 20 * 60, 1), 1.0f) // 幸运
    ...
    public static final FoodProperties PICKLED_MUSTARD_PORK_MOONCAKE = new FoodProperties.Builder().nutrition(14).saturationModifier(0.4f).build(); // 榨菜鲜肉月饼
