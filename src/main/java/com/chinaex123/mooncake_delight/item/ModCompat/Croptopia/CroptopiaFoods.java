...
public class CroptopiaFoods {
    ...
    public static final FoodProperties BLACK_SESAME_PEPPER_SALT_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 黑麻椒盐月饼
    ...
    public static final FoodProperties MANGO_COCONUT_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 芒果椰奶月饼
    public static final FoodProperties CINNAMON_APPLE_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 肉桂苹果月饼
    public static final FoodProperties TROPICAL_FRUIT_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 2), 1.0f) // 速度
            .effect(() -> new MobEffectInstance(MobEffects.JUMP, 400, 2), 1.0f) // 跳跃提升
            .alwaysEdible().build(); // 热带水果月饼
    public static final FoodProperties BERRY_MEDLEY_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 400, 2), 1.0f) // 生命恢复
            .effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 400), 1.0f) // 夜视
            .alwaysEdible().build(); // 浆果荟萃月饼
    public static final FoodProperties CITRUS_BLAST_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 2), 1.0f) // 速度
            .effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 400), 1.0f) // 抗火
            .alwaysEdible().build(); // 柑橘炸弹月饼
    public static final FoodProperties WALNUT_DATE_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 200, 2), 1.0f) // 生命恢复
            .alwaysEdible().build(); // 核桃枣泥月饼
    public static final FoodProperties ALMOND_CHERRY_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.JUMP, 200, 2), 1.0f) // 跳跃提升
            .alwaysEdible().build(); // 扁桃仁樱桃月饼
    public static final FoodProperties CASHEW_MANGO_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 200, 2), 1.0f) // 速度
            .alwaysEdible().build(); // 腰果芒果月饼
    public static final FoodProperties SHRIMP_ASPARAGUS_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 200, 2), 1.0f) // 速度
            .alwaysEdible().build();  // 鲜虾芦笋月饼
    public static final FoodProperties CRAB_CORNS_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 2), 1.0f) // 力量
            .effect(() -> new MobEffectInstance(MobEffects.DIG_SPEED, 200, 2), 0.5f) // 急迫
            .alwaysEdible().build(); // 螃蟹玉米月饼
    public static final FoodProperties TUNA_AVOCADO_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.ABSORPTION, 200, 2), 1.0f) // 伤害吸收
            .alwaysEdible().build(); // 金枪鱼牛油果月饼
    public static final FoodProperties SPINACHE_WALNUT_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 2), 1.0f) // 力量
            .alwaysEdible().build(); // 菠菜核桃月饼
    public static final FoodProperties PINEAPPLE_HAM_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 200, 2), 1.0f) // 生命恢复
            .alwaysEdible().build(); // 菠萝火腿月饼
    public static final FoodProperties CRANBERRY_WALNUT_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.LUCK, 1200, 2), 0.5f) // 幸运
            .alwaysEdible().build(); // 蔓越莓核桃月饼
    public static final FoodProperties BLUEBERRY_YOGURT_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.SLOW_FALLING, 1200, 2), 0.5f) // 缓降
            .alwaysEdible().build(); // 蓝莓酸奶月饼
    public static final FoodProperties SEAFOOD_MEDLEY_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.WATER_BREATHING, 1200, 2), 1.0f) // 水下呼吸
            .effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 1200, 1), 1.0f) // 夜视
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1200, 1), 0.5f) // 抗性提升
            .alwaysEdible().build(); // 海鲜总汇月饼
    public static final FoodProperties KING_OF_VEGGIES_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1200, 1), 1.0f) // 抗性提升
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 1200, 2), 1.0f) // 生命恢复
            .alwaysEdible().build(); // 蔬菜之王月饼
    public static final FoodProperties BACON_ONION_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 1), 1.0f) // 力量
            .effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 80, 1), 0.8f) // 反胃
            .alwaysEdible().build();  // 培根洋葱月饼
    public static final FoodProperties FIVE_KERNELS_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 五仁月饼
    public static final FoodProperties BBQ_PORK_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 叉烧月饼
    public static final FoodProperties BBQ_PORK_FIVE_KERNELS_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 叉烧五仁月饼
    public static final FoodProperties JINHUA_HAM_FIVE_KERNELS_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 金腿五仁月饼
    ...
    public static final FoodProperties WALNUT_DATE_PASTE_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 核桃枣泥月饼
    public static final FoodProperties PRESERVED_MUSTARD_GREEN_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 梅干菜月饼
    public static final FoodProperties PICKLED_MUSTARD_PORK_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 榨菜鲜肉月饼
    public static final FoodProperties MILK_TEA_MOONCAKE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.4f).build(); // 奶茶月饼
