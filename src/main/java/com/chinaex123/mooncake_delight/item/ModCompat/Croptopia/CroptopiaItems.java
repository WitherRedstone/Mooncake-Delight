...
public class CroptopiaItems {
    ...
    public static final DeferredItem<Item> WALNUT_DATE_MOONCAKE = ITEMS_REGISTER.register("walnut-date_mooncake", () -> new Item(new Item.Properties().food(CroptopiaFoods.WALNUT_DATE_MOONCAKE))); // 核桃枣泥月饼
    ...
    public static final DeferredItem<Item> BACON_ONION_MOONCAKE = ITEMS_REGISTER.register("bacon-onion_mooncake", () -> new Item(new Item.Properties().food(CroptopiaFoods.BACON_ONION_MOONCAKE))); // 培根洋葱月饼
